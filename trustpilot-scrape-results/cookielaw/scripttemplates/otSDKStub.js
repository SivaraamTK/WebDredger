...
function e() {
    ...
    this.implementThePolyfill = function() {
        ...
        return Element.prototype.setAttribute = function(t, e) {
            if ("style" !== t.toLowerCase() & amp; & amp; o.apply(this, [t, e]), "style" !== t.toLowerCase() || e || this.removeAttribute("style"), "style" === t.toLowerCase() & amp; & amp; e) {
...
function l(t, e, i) {
    ...
    function n(t) {
        return t ? (";" !== (t = t.trim()).charAt(t.length - 1) & amp; & amp;
            (t += ";"), t.trim()) : null
    }
...
var d = new function() {
        ...
        this.LOCATOR_NAME = "__gppLocator", this.win = window, this.customInit = "CUSTOMINIT", this.init = function() {
            s.win.__gpp & amp; & amp;
            "function" == typeof s.win.__gpp || (s.win.__gpp = s.executeGppApi, window.addEventListener("message", s.messageHandler, !1), s.addFrame(s.LOCATOR_NAME))
            ...
            for (var t = [], e = 0; e & lt; arguments.length; e++) t[e] = arguments[e];
            var i = null == (i = s.win) ? void 0 : i.__gpp;
            if (i.queue = i.queue || [], i.events = i.events || [], !t.length || 1 === t.length & amp; & amp;
                "queue" === t[0]) return i.queue;
            if (1 === t.length & amp; & amp;
                "events" === t[0]) return i.events;
            var n = t[0],
                a = 1 & lt;
            t.length ? t[1] : null, o = 2 & lt;
            t.length ? t[2] : null;
            switch (n) {
                case c.ping:
            ...
            var i, n = s.win.__gpp;
            return n.events = n.events || [], null != (i = n) & amp; & amp;
            i.lastId || (n.lastId = 0), n.lastId++, n.events.push({
                id: n.lastId,
                callback: t,
                parameter: e
            }), {
            ...
            e & amp; & amp;
            e.__gppCall & amp; & amp;
            (n = e.__gppCall, (0, s.win.__gpp)(n.command, function(t, e) {
                t = {
                    __gppReturn: {
                        returnValue: t,
                        success: e,
    ...
    m = (h.prototype.initConsentSDK = function() {
        ...
        var e = t & amp; & amp;
        t.TenantFeatures, i = window.location.hostname, n = t.Domain, a = t.BulkDomainCheckUrl;
        e & amp; & amp;
        e.CookieV2BulkDomainManagement & amp; & amp;
        i !== n & amp; & amp;
        t.ScriptType === u & amp; & amp;
        ((e = window.sessionStorage) & amp; & amp; e.getItem("bulkDomainMgmtEnabled") ? this.handleBulkDomainMgmt({
        ...
        if (this.setDomainIfBulkDomainEnabled(t), this.updateVersion(t), (t.TenantFeatures & amp; & amp; t.TenantFeatures.CookieV2CSP || t.CookieV2CSPEnabled) & amp; & amp; this.nonce & amp; & amp;
            (this.setAttributePolyfillIsActive = !0, (new n).implementThePolyfill()), !t.RuleSet[0].Type) return this.iabTypeAdded = !1, window.__tcfapi = this.executeTcfApi, this.intializeIabStub(), this.addBannerSDKScript(t);
        var e, i = window;
        i.OneTrust & amp; & amp;
        i.OneTrust.geolocationResponse ? (i = i.OneTrust.geolocationResponse, this.setGeoLocation(i.countryCode, i.stateCode), this.addBannerSDKScript(t)) : (i = this.readCookieParam(p.optanonCookieName, p.geolocationCookiesParam)) || t.SkipGeolocation ? (e = i.split(";")[0], i = i.split(";")[1], this.setGeoLocation(e, i), this.addBannerSDKScript(t)) : this.getGeoLocation(t)
    }, h.prototype.handleBulkDomainMgmt = function(t, e) {
        window.sessionStorage & amp; & amp;
        window.sessionStorage.setItem("bulkDomainMgmtEnabled", JSON.stringify(t.isValid)), t.isValid & amp; & amp;
        ...
        return new RegExp("^file://", "i").test(e) & amp; & amp;
        t.MobileSDK ? (e = "/" + t.GeolocationUrl.replace(/^(http|https):\/\//, "").split("/").slice(1).join("/") + ".js", p.storageBaseURL + e) : t.GeolocationUrl
    }, h.prototype.geoLocationJsonCallback = function(t, e) {
        e & amp; & amp;
        this.setGeoLocation(e.country, e.state), this.addBannerSDKScript(t)
        ...
        void 0 === e & amp; & amp;
        (e = !1), void 0 === n & amp; & amp;
        (n = null);
        var o = window.sessionStorage & amp; & amp;
        window.sessionStorage.getItem("otPreviewData");
        if (new RegExp("^file://", "i").test(t)) this.otFetchOfflineFile(t, i);
        else if (0 & lt; = t.indexOf("/consent/") & amp; & amp; this.previewMode & amp; & amp; o) {
            ...
            if (s.onload = function(t) {
                    var e;
                    this & amp; & amp;
                    this.responseText ? e = this.responseText : t & amp; & amp;
                    t.target & amp; & amp;
                    (e = t.target.responseText), a ? i(JSON.parse(e), a) : i(JSON.parse(e))
                }, s.onerror = function() {
                    i()
                }, s.open("GET", t), s.withCredentials = !1, e & amp; & amp; s.setRequestHeader("accept", "application/json"), n)
        ...
        i.setAttribute("src", t), this.nonce & amp; & amp;
        i.setAttribute("nonce", this.nonce), i.async = !0, i.type = "text/javascript", this.crossOrigin & amp; & amp;
        i.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(i), new RegExp("^file://", "i").test(t) || p.mobileOnlineURL.push(t), e & amp; & amp;
        ...
        if (!a.country & amp; & amp; !a.state) return o & amp; & amp;
        0 & lt;
        o.length ? o[0] : null;
        for (var s = a.state.toLowerCase(), r = a.country.toLowerCase(), u = 0; u & lt; t.RuleSet.length; u++)
            if (!0 === t.RuleSet[u].Global) n = t.RuleSet[u];
            else {
                var l = t.RuleSet[u].States;
                if (l[r] & amp; & amp; 0 & lt; = l[r].indexOf(s)) {
                    i = t.RuleSet[u];
                    break
                }
                0 & lt; = t.RuleSet[u].Countries.indexOf(r) & amp; & amp;
                (e = t.RuleSet[u])
            } return i || e || n
        ...
        t ? this.isBoolean(t) ? p.oneTrustIABgdprAppliesGlobally = "true" === t : p.oneTrustIABgdprAppliesGlobally = 0 & lt; = p.EUCOUNTRIES.indexOf(t): p.isStubReady = !1
        ...
        if (t) {
            for (n = {}, a = t.split("&amp;"), i = 0; i & lt; a.length; i += 1) o = a[i].split("="), n[decodeURIComponent(o[0])] = decodeURIComponent(o[1]).replace(/\+/g, " ");
            return e & amp; & amp;
            n[e] ? n[e] : e & amp; & amp;
            !n[e] ? "" : n
        }
        ...
        for (var i, n = t + "=", a = document.cookie.split(";"), o = 0; o & lt; a.length; o += 1) {
            for (i = a[o];
        ...
        for (var t = [], e = p.optanonHtmlGroupData.length, i = 0; i & lt; e; i++) this.endsWith(p.optanonHtmlGroupData[i], ":1") & amp; & amp;
        t.push(p.optanonHtmlGroupData[i].replace(":1", ""));
        for (e = p.optanonHostData.length, i = 0; i & lt; e; i++) this.endsWith(p.optanonHostData[i], ":1") & amp; & amp;
        t.push(p.optanonHostData[i].replace(":1", ""));
        for (e = p.genVendorsData.length, i = 0; i & lt; e; i++) this.endsWith(p.genVendorsData[i], ":1") & amp; & amp;
        t.push(p.genVendorsData[i].replace(":1", ""));
        for (e = p.vendorsServiceData.length, i = 0; i & lt; e; i++) this.endsWith(p.vendorsServiceData[i], ":1") & amp; & amp;
        ...
        var n, a = "," + this.serialiseArrayToString(t) + ",",
            ...
            s = (this.otDataLayer.ignore || void 0 === o[this.otDataLayer.name] ? this.otDataLayer.ignore || (o[this.otDataLayer.name] = [{
                ...
                }]) : o[this.otDataLayer.name].constructor === Array & amp; & amp;
        ...
        t.length & amp; & amp;
        (o[this.otDataLayer.name].constructor === Array & amp; & amp; o[this.otDataLayer.name].push({
            ...
            t.length & amp; & amp;
            window.dispatchEvent(s), n & amp; & amp;
        ...
        return !t || (t = t.split("?")).length & lt;
        2 ? null : new URLSearchParams(t[1]).get(e)
    }, h.prototype.setStubScriptElement = function() {
        p.stubScriptElement = document.querySelector("script[src*='" + p.stubFileName + "']");
        var t = p.stubScriptElement & amp; & amp;
        p.stubScriptElement.getAttribute("src"), t = t & amp; & amp;
        this.getStubQueryParam(t, "did");
        p.stubScriptElement & amp; & amp;
        p.stubScriptElement.hasAttribute(p.DATAFILEATTRIBUTE) ? this.domainId = p.stubScriptElement.getAttribute(p.DATAFILEATTRIBUTE).trim() : t ? this.domainId = t : p.stubScriptElement || (p.stubScriptElement = document.querySelector("script[src*='" + p.migratedCCTID + "']"), p.stubScriptElement & amp; & amp;
            (p.isMigratedURL = !0, this.domainId = p.migratedDomainId.trim()))
    }, h.prototype.setDomainDataFileURL = function() {
        var t = p.stubScriptElement.getAttribute("src"),
            e = -1 & lt;
        t.indexOf("/consent");
        t & amp; & amp;
        (p.isMigratedURL ? p.storageBaseURL = t.split("/consent/" + p.migratedCCTID)[0] : p.storageBaseURL = (e ? t.split("/consent") : t.split("/scripttemplates/" + p.stubFileName))[0]), this.storageBaseURL = p.storageBaseURL, this.isPreview & amp; & amp; - 1 === this.domainId.indexOf("test") ? this.domainId = this.domainId + "-test" : this.isPreview = !1, p.bannerBaseDataURL = p.storageBaseURL & amp; & amp;
        p.storageBaseURL + "/consent/" + this.domainId, p.bannerDataParentURL = p.bannerBaseDataURL + "/" + this.domainId + ".json"
        ...
        this.isReset = t || i & amp; & amp;
        new Date(i) & lt;
        new Date, this.isPreview = !this.isReset & amp; & amp;
        (e || i & amp; & amp; new Date(i) & gt; new Date), this.setGeoParam(this.geoFromUrl || n)
    }, h.prototype.setGeoParam = function(t) {
        var e;
        t & amp; & amp;
        ((e = window).OneTrust || (e.OneTrust = {}), t = t.split(","), e.OneTrust.geolocationResponse = {
            countryCode: t[0],
            stateCode: t[1]
        })
    }, h.prototype.updateVersion = function(t) {
        "debug" !== this.buildType & amp; & amp;
        "cybuild" !== this.buildType || (t.Version = "202405.2.0")
    }, h);
...
function h() {
    ...
    this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.buildType = "undefined", this.addBannerSDKScript = function(t) {
        var e = s.getRegionSet(t),
            i = (e.GCEnable || (s.updateGtmMacros(), s.gtmUpdated = !0), s.iabTypeAdded & amp; & amp;
                ("IAB2" !== e.Type & amp; & amp;
                    "IAB2V2" !== e.Type || (s.iabType = e.Type, s.intializeIabStub()), "IAB2" !== e.Type) & amp; & amp;
                "IAB2V2" !== e.Type & amp; & amp; s.removeTcf(), e.IsGPPEnabled ? d.init() : d.removeGppApi(), p.stubScriptElement.cloneNode(!0)),
            n = "",
            n = t.UseSDKRefactor ? (p.isMigratedURL & amp; & amp;
                (i.src = p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + p.stubFileName + ".js"), p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + t.Version + "/" + p.bannerScriptName) : "5.11.0" === t.Version ? (p.isMigratedURL & amp; & amp;
                (i.src = p.storageBaseURL + "/scripttemplates/old/scripttemplates/" + p.stubFileName + ".js"), p.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + p.bannerScriptName) : (p.isMigratedURL & amp; & amp;
                (i.src = p.storageBaseURL + "/scripttemplates/" + p.stubFileName + ".js"), p.storageBaseURL + "/scripttemplates/" + t.Version + "/" + p.bannerScriptName);
        ["charset", "data-language", "data-document-language", "data-domain-script", "crossorigin", "data-ignore-ga"].forEach(function(t) {
            p.stubScriptElement.getAttribute(t) & amp; & amp;
        ...
        var t = window;
        s.iabTypeAdded ? (void 0 === t.__tcfapi & amp; & amp;
            (window.__tcfapi = s.executeTcfApi), s.addIabFrame()) : s.addBackwardIabFrame(), t.receiveOTMessage = s.receiveIabMessage, (t.attachEvent || window.addEventListener)("message", t.receiveOTMessage, !1)
        ...
        e.__cmpCall & amp; & amp;
        "IAB2" === s.iabType & amp; & amp;
        console.log("Expecting IAB TCF v2.0 vendor iFrame call; Received IAB TCF v1.1"), e.__tcfapiCall & amp; & amp;
        "IAB2" === s.iabType & amp; & amp;
        (n = e.__tcfapiCall.callId, a = e.__tcfapiCall.command, t = e.__tcfapiCall.parameter, e = e.__tcfapiCall.version, s.executeTcfApi(a, t, function(t, e) {
            t = {
                __tcfapiReturn: {
                    returnValue: t,
                    success: e,
