...
function(t) {
    ...
    e.parse = function(t) {
        ...
        r[2] = parseInt(r[2], 10) || 1, r[3] = parseInt(r[3], 10) || 1, r[2]--, r[8] = r[8] ? (r[8] + "00").substring(0, 3) : 0, " " === r[4] ? i = (new Date).getTimezoneOffset() : "Z" !== r[9] & amp; & amp;
        r[10] & amp; & amp;
        (i = 60 * r[11] + r[12], "+" === r[10] & amp; & amp;
            (i = 0 - i));
        var u = Date.UTC(r[1], r[2], r[3], r[5], r[6] + i, r[7], r[8]);
        return new Date(u)
    }, e.is = function(t, e) {
        return "string" == typeof t & amp; & amp;
        ((!e || !1 !== /^\d{4}-\d{2}-\d{2}/.test(t)) & amp; & amp; n.test(t))
    }
}, 1285: function(t) {
    ...
    t.exports = function(t) {
        ...
        }(t) ? new Date((n = t) & lt; 315576e5 ? 1e3 * n : n) : r.is(t) ? r.parse(t) : i.is(t) ? i.parse(t) : o.is(t) ? o.parse(t) : new Date(t);
        var e, n
    }
}, 5228: function(t, e) {
    "use strict";
    ...
    function n(t, e) {
        return t.hasOwnProperty(e) & amp; & amp;
        delete t[e], t
    }
    ...
    var c = function() {
        function t(t) {
            ...
            if (this.host = null !== (e = null == t ? void 0 : t.host) & amp; & amp; void 0 !== e ? e : u.U, this.sampleRate = null !== (n = null == t ? void 0 : t.sampleRate) & amp; & amp; void 0 !== n ? n : 1, this.flushTimer = null !== (r = null == t ? void 0 : t.flushTimer) & amp; & amp; void 0 !== r ? r : 3e4, this.maxQueueSize = null !== (i = null == t ? void 0 : t.maxQueueSize) & amp; & amp; void 0 !== i ? i : 20, this.protocol = null !== (o = null == t ? void 0 : t.protocol) & amp; & amp; void 0 !== o ? o : "https", this.queue = [], this.sampleRate & gt; 0) {
                var c = !1,
                    l = function() {
        ...
        return t.prototype.increment = function(t, e) {
            if (t.includes("analytics_js.") & amp; & amp; 0 !== e.length & amp; & amp; !(Math.random() & gt; this.sampleRate || this.queue.length & gt; = this.maxQueueSize)) {
                ...
                this.queue.push(n), t.includes("error") & amp; & amp;
                this.flush().catch(a)
            }
            ...
            return (0, r.mG)(this, void 0, Promise, (function() {
                ...
                return (0, r.Jh)(this, (function(e) {
                    switch (e.label) {
                        case 0:
                            return this.queue.length & lt; = 0 ? [2] : [4, this.send().catch((function(e) {
                                a(e), t.sampleRate = 0
                            }))];
                        case 1:
                            return e.sent(), [2]
    ...
    try {
        window.analyticsWriteKey = "8tb69qtawc"
    } catch (t) {}
    ...
    var i = n(3744),
        o = function() {
            ...
            var n = (0, i.R)();
            return (n & amp; & amp; n.fetch || r).apply(void 0, t)
        }
}, 3744: function(t, e, n) {
    "use strict";
    n.d(e, {
    ...
    function i(t, e) {
        ...
        return new Promise((function(n, r) {
            ...
            for (var s = 0, u = Object.entries(null != e ? e : {}); s & lt; u.length; s++) {
                var a = u[s],
                    c = a[0],
                    l = a[1];
                o.setAttribute(c, l)
    ...
    function i(t, e) {
        var n, i = Object.entries(null !== (n = e.integrations) & amp; & amp; void 0 !== n ? n : {}).reduce((function(t, e) {
            var n, i, o = e[0],
                s = e[1];
    ...
    var r, i = n(6249),
        ...
        a = function() {
            ...
            var n, o = (Array.prototype.slice.call(document.querySelectorAll("script")).forEach((function(t) {
                var e, r = null !== (e = t.getAttribute("src")) & amp; & amp;
                void 0 !== e ? e : "", i = s.exec(r);
                i & amp; & amp;
                i[1] & amp; & amp;
                (n = i[1])
            })), n);
    ...
    function l() {
        for (var t, e, n, r = null !== (t = (0, o.M)()) & amp; & amp; void 0 !== t ? t : null === (e = (0, i.wI)()) || void 0 === e ? void 0 : e._writeKey, u = void 0, a = 0, c = Array.prototype.slice.call(document.querySelectorAll("script")); a & lt; c.length; a++) {
            var l = null !== (n = c[a].getAttribute("src")) & amp; & amp;
            void 0 !== n ? n : "", p = s.exec(l);
            if (p & amp; & amp; p[1]) {
                u = l;
                break
            }
    ...
    try {
        u = (0, s.j)() & amp; & amp;
        window.localStorage ? window.localStorage : u
    } catch (t) {
    ...
    function i(t, e) {
        ...
        return "track" === t.type & amp; & amp;
        (n = new r.Track(t, e)), "identify" === t.type & amp; & amp;
        (n = new r.Identify(t, e)), "page" === t.type & amp; & amp;
        (n = new r.Page(t, e)), "alias" === t.type & amp; & amp;
        (n = new r.Alias(t, e)), "group" === t.type & amp; & amp;
        (n = new r.Group(t, e)), "screen" === t.type & amp; & amp;
        (n = new r.Screen(t, e)), Object.defineProperty(n, "obj", {
            value: t,
            writable: !0
        }), n
    }
    ...
    var o = function() {
        return o = Object.assign || function(t) {
            for (var e, n = 1, r = arguments.length; n & lt; r; n++)
                for (var i in e = arguments[n]) Object.prototype.hasOwnProperty.call(e, i) & amp; & amp;
            (t[i] = e[i]);
            return t
    ...
    function s(t, e) {
        ...
        if (null != t & amp; & amp;
            ...
            var i = 0;
            for (r = Object.getOwnPropertySymbols(t); i & lt; r.length; i++) e.indexOf(r[i]) & lt;
            0 & amp; & amp;
            Object.prototype.propertyIsEnumerable.call(t, r[i]) & amp; & amp;
            (n[r[i]] = t[r[i]])
        }
        return n
    }
                ...
                return function(u) {
                    ...
                    for (; o & amp; & amp;
                        (o = 0, u[0] & amp; & amp;
                            (s = 0)), s;) try {
                        if (n = 1, r & amp; & amp;
                            (i = 2 & amp; u[0] ? r.return : u[0] ? r.throw || ((i = r.return) & amp; & amp; i.call(r), 0) : r.next) & amp; & amp; !(i = i.call(r, u[1])).done) return i;
                        switch (r = 0, i & amp; & amp;
                            (u = [2 & amp;u[0], i.value]), u[0]) {
                            case 0:
                            case 1:
                                i = u;
                                break;
                            ...
                            case 7:
                                ...
                                continue;
                            default:
                                if (!(i = s.trys, (i = i.length & gt; 0 & amp; & amp; i[i.length - 1]) || 6 !== u[0] & amp; & amp; 2 !== u[0])) {
                                    s = 0;
                                    continue
                                }
                                if (3 === u[0] & amp; & amp;
                                    (!i || u[1] & gt; i[0] & amp; & amp; u[1] & lt; i[3])) {
                                    s.label = u[1];
                                    break
                                }
                                if (6 === u[0] & amp; & amp; s.label & lt; i[1]) {
                                    s.label = i[1], i = u;
                                    break
                                }
                                if (i & amp; & amp; s.label & lt; i[2]) {
    ...
    function c(t, e, n) {
        if (n || 2 === arguments.length)
            for (var r, i = 0, o = e.length; i & lt; o; i++) !r & amp; & amp;
        i in e || (r || (r = Array.prototype.slice.call(e, 0, i)), r[i] = e[i]);
    ...
    var r = n(7831),
            ...
            return t.prototype.log = function(t, e, n) {
                ...
                if (this.logs.length & gt; 1) {
                    var t = this._logs.reduce((function(t, e) {
                        ...
                        delete s.time;
                        var u = null !== (i = null === (r = e.time) || void 0 === r ? void 0 : r.toISOString()) & amp; & amp;
                        void 0 !== i ? i : "";
                        return t[u] & amp; & amp;
                        (u = "".concat(u, "-").concat(Math.random())), (0, o.pi)((0, o.pi)({}, t), ((n = {})[u] = s, n))
                    }), {});
        ...
        a = function(t) {
            var e, n, r;
            this.retry = null === (e = t.retry) || void 0 === e || e, this.type = null !== (n = t.type) & amp; & amp;
            void 0 !== n ? n : "plugin Error", this.reason = null !== (r = t.reason) & amp; & amp;
            void 0 !== r ? r : ""
        },
        c = function() {
            function t(t, e, n, i) {
                void 0 === e & amp; & amp;
                (e = (0, r.v4)()), void 0 === n & amp; & amp;
                (n = new u.i), void 0 === i & amp; & amp;
                (i = new s), this.attempts = 0, this.event = t, this._id = e, this.logger = i, this.stats = n
            }
    ...
    var o = "onRemoveFromFuture",
        s = function(t) {
            ...
            return (0, r.ZT)(e, t), e.prototype.push = function() {
                for (var t = this, e = [], n = 0; n & lt; arguments.length; n++) e[n] = arguments[n];
                var r = e.map((function(e) {
                    return !(t.updateAttempts(e) & gt; t.maxAttempts || t.includes(e)) & amp; & amp;
                    (t.queue.push(e), !0)
                }));
                ...
                if (n & gt; this.maxAttempts || this.includes(t)) return !1;
                var r = function(t) {
                    var e = Math.random() + 1,
                        n = t.minTimeout,
                        r = void 0 === n ? 500 : n,
                ...
                var e;
                return null !== (e = this.seen[t.id]) & amp; & amp;
                void 0 !== e ? e : 0
    ...
    function o(t, e) {
        ...
        return void 0 === o ? Promise.resolve(t) : function(t) {
            ...
            if (n instanceof i.Y & amp; & amp;
                "middleware_cancellation" === n.type) throw n;
    ...
    var r = function() {
        function t(t) {
            var e;
            this.callbacks = {}, this.warned = !1, this.maxListeners = null !== (e = null == t ? void 0 : t.maxListeners) & amp; & amp;
            void 0 !== e ? e : 10
        }
        return t.prototype.warnIfPossibleMemoryLeak = function(t) {
            this.warned || this.maxListeners & amp; & amp;
            this.callbacks[t].length & gt;
            this.maxListeners & amp; & amp;
            ...
            var n = this,
                r = function() {
                    for (var i = [], o = 0; o & lt; arguments.length; o++) i[o] = arguments[o];
                    n.off(t, r), e.apply(n, i)
                };
            return this.on(t, r), this
        }, t.prototype.off = function(t, e) {
            var n, r = (null !== (n = this.callbacks[t]) & amp; & amp; void 0 !== n ? n : []).filter((function(t) {
                return t !== e
            }));
            return this.callbacks[t] = r, this
        }, t.prototype.emit = function(t) {
            for (var e, n = this, r = [], i = 1; i & lt; arguments.length; i++) r[i - 1] = arguments[i];
            var o = null !== (e = this.callbacks[t]) & amp; & amp;
            void 0 !== e ? e : [];
    ...
    function s() {
        ...
        for (; e & lt; 16; e++) t = r[i + e], n += 6 == e ? o[15 & amp; t | 64] : 8 == e ? o[63 & amp; t | 128] : o[t], 1 & amp;
        e & amp; & amp;
        e & gt;
        1 & amp; & amp;
        e & lt;
    ...
    function r(t, e, n) {
        e.split & amp; & amp;
        (e = e.split("."));
        for (var r, i, o = 0, s = e.length, u = t; o & lt; s & amp; & amp;
            "__proto__" !== (i = e[o++]) & amp; & amp;
            "constructor" !== i & amp; & amp;
            "prototype" !== i;) u = u[i] = o === s ? n : typeof(r = u[i]) == typeof e ? r : 0 * e[o] != 0 || ~("" + e[o]).indexOf(".") ? {} : []
    }
    n.d(e, {
        N: function() {
            return r
...
s.m = i, s.n = function(t) {
        ...
        if (1 & amp; r & amp; & amp;
            (n = this(n)), 8 & amp; r) return n;
        if ("object" == typeof n & amp; & amp; n) {
            if (4 & amp; r & amp; & amp; n.__esModule) return n;
            if (16 & amp; r & amp; & amp;
                "function" == typeof n.then) return n
        }
        var i = Object.create(null);
        s.r(i);
        var o = {};
        t = t || [null, e({}), e([]), e(e)];
        for (var u = 2 & amp; r & amp; & amp; n;
            "object" == typeof u & amp; & amp; !~t.indexOf(u); u = e(u)) Object.getOwnPropertyNames(u).forEach((function(t) {
            o[t] = function() {
                return n[t]
            }
        }));
        ...
        for (var n in e) s.o(e, n) & amp; & amp;
        !s.o(t, n) & amp; & amp;
        ...
        if (n[t]) n[t].push(e);
            ...
            var u, a;
            if (void 0 !== i)
                for (var c = document.getElementsByTagName("script"), l = 0; l & lt; c.length; l++) {
                    var p = c[l];
            ...
            u || (a = !0, (u = document.createElement("script")).charset = "utf-8", u.timeout = 120, s.nc & amp; & amp; u.setAttribute("nonce", s.nc), u.setAttribute("data-webpack", r + i), u.src = t), n[t] = [e];
            var f = function(e, r) {
                    u.onerror = u.onload = null, clearTimeout(d);
                    var i = n[t];
                    if (delete n[t], u.parentNode & amp; & amp; u.parentNode.removeChild(u), i & amp; & amp; i.forEach((function(t) {
                            return t(r)
                        })), e) return e(r)
                },
            ...
            u.onerror = f.bind(null, u.onerror), u.onload = f.bind(null, u.onload), a & amp; & amp;
    ...
    function() {
                    ...
                    s.l(o, (function(n) {
                        if (s.o(t, e) & amp; & amp;
                            (0 !== (r = t[e]) & amp; & amp;
                                (t[e] = void 0), r)) {
                            var i = n & amp; & amp;
                            ("load" === n.type ? "missing" : n.type), o = n & amp; & amp;
                            n.target & amp; & amp;
                            n.target.src;
        ...
        var e = function(e, n) {
                ...
                if (o.some((function(e) {
                    ...
                    for (r in u) s.o(u, r) & amp; & amp;
                    (s.m[r] = u[r]);
                    if (a) a(s)
                }
                for (e & amp; & amp; e(n); c & lt; o.length; c++) i = o[c], s.o(t, i) & amp; & amp;
                t[i] & amp; & amp;
                t[i][0](), t[i] = 0
            },
...
! function() {
    ...
    function r() {
        return "undefined" != typeof process & amp; & amp;
    ...
    function a(t, e, n, r) {
        ...
        var a = (0, o.PO)(t) ? null !== (i = t.properties) & amp; & amp;
        void 0 !== i ? i : {}: (0, o.PO)(e) ? e : {}, c = {};
        return (0, o.mf)(n) || (c = null != n ? n : {}), (0, o.PO)(t) & amp; & amp;
        !(0, o.mf)(e) & amp; & amp;
        (c = null != e ? e : {}), [u, a, c, s.find(o.mf)]
    }
    ...
    function c(t, e, n, r, i) {
        ...
        void 0 !== p[0] & amp; & amp;
        void 0 !== p[1] & amp; & amp;
        (a = p[0], c = p[1]), 1 === p.length & amp; & amp;
        (a = null, c = p[0]);
        var f = l.find(o.mf),
            d = l.filter((function(t) {
                return null === c ? (0, o.PO)(t) : (0, o.PO)(t) || null === t
            })),
            h = null !== (s = d[0]) & amp; & amp;
        void 0 !== s ? s : {}, v = null !== (u = d[1]) & amp; & amp;
        void 0 !== u ? u : {};
        return [a, c, h, v, f]
    }
    var l = function(t) {
        return function() {
            for (var e, n, r, i = [], s = 0; s & lt; arguments.length; s++) i[s] = arguments[s];
            for (var u = {}, a = ["callback", "options", "traits", "id"], c = 0, l = i; c & lt; l.length; c++) {
                var p = l[c],
                    f = a.pop();
                if ("id" === f) {
                ...
                if ("traits" !== f & amp; & amp;
                    "options" !== f || null != p & amp; & amp; !(0, o.PO)(p) || (u[f] = p), (0, o.mf)(p)) {
                    u.callback = p;
                    break
                }
            }
            return [null !== (e = u.id) & amp; & amp;void 0 !== e ? e : t.id(), null !== (n = u.traits) & amp; & amp;void 0 !== n ? n : {}, null !== (r = u.options) & amp; & amp;void 0 !== r ? r : {}, u.callback]
        }
    };

    function p(t, e, n, r) {
        (0, o.hj)(t) & amp; & amp;
        (t = t.toString()), (0, o.hj)(e) & amp; & amp;
        (e = e.toString());
        var i = [t, e, n, r],
            s = i.filter(o.HD),
            u = s[0],
            ...
            return (0, t.Jh)(this, (function(t) {
                switch (t.label) {
                    ...
                    case 5:
                        s = t.sent(), t.label = 6;
                    case 6:
                        return (null == i ? void 0 : i.debug) & amp; & amp;
                        s.flush(), [2, s]
                }
                var u, a, c
            }))
    ...
    var w = function(t) {
        ...
        _ = function() {
            ...
            return g(location.href, t & amp; & amp; t.getAttribute("href") || void 0, location.search, location.pathname, document.title, document.referrer)
        },
        x = function(e, n) {
            void 0 === n & amp; & amp;
            (n = w(_()));
            ...
            "page" === e.type & amp; & amp;
            (r = e.properties & amp; & amp;
                (i = e.properties, o = Object.keys(n), Object.assign.apply(Object, (0, t.ev)([{}], o.map((function(t) {
                    var e;
                    if (i & amp; & amp; Object.prototype.hasOwnProperty.call(i, t)) return (e = {})[t] = i[t], e
    ...
    var M = function(t) {
            var e, n;
            this.settings = t, this.createMessageId = t.createMessageId, this.onEventMethodCall = null !== (e = t.onEventMethodCall) & amp; & amp;
            void 0 !== e ? e : function() {}, this.onFinishedEvent = null !== (n = t.onFinishedEvent) & amp; & amp;
            void 0 !== n ? n : function() {}
        },
        E = function() {
            function e(t) {
            ...
            return e.prototype.track = function(e, n, r, i) {
                ...
                (u.category = e, u.properties = null !== (s = u.properties) & amp; & amp; void 0 !== s ? s : {}, u.properties.category = e), null !== n & amp; & amp;
                (u.name = n), this.normalize((0, t.pi)((0, t.pi)({}, this.baseEvent()), u))
                ...
                return null !== e & amp; & amp;
                (s.category = e), null !== n & amp; & amp;
                (s.name = n), this.normalize((0, t.pi)((0, t.pi)({}, this.baseEvent()), s))
                ...
                (o.previousId = n), void 0 === e ? this.normalize((0, t.pi)((0, t.pi)({}, o), this.baseEvent())) : this.normalize((0, t.pi)((0, t.pi)({}, this.baseEvent()), o))
                ...
                var r = Object.keys(t),
                    i = null !== (e = t.context) & amp; & amp;
                void 0 !== e ? e : {}, o = {};
                return r.forEach((function(e) {
                    "context" !== e & amp; & amp;
                    (n.includes(e) ? (0, S.N)(o, e, t[e]) : (0, S.N)(i, e, t[e]))
                })), [i, o]
            }, e.prototype.normalize = function(e) {
                var n, r, i, o, s = Object.keys(null !== (n = e.integrations) & amp; & amp; void 0 !== n ? n : {}).reduce((function(n, r) {
                    var i, o;
        ...
        A = function(e) {
            ...
            return (0, t.ZT)(n, e), n.prototype.maybeUpdateAnonId = function(t) {
                (null == t ? void 0 : t.anonymousId) & amp; & amp;
                this.user.anonymousId(t.anonymousId)
            }, n.prototype.addIdentity = function(t) {
                this.user.id() & amp; & amp;
                (t.userId = this.user.id()), this.user.anonymousId() & amp; & amp;
        ...
        F = function(t) {
            return "addMiddleware" in t & amp; & amp;
            "destination" === t.type
        },
        D = s(3061);
    var T = s(3098),
        ...
        N = function(e) {
            function n(t) {
                ...
                return o.criticalTasks = (i = 0, {
                    ...
                    run: function(t) {
                        var e, o = t();
                        return "object" == typeof(e = o) & amp; & amp;
                        null !== e & amp; & amp;
                        "then" in e & amp; & amp;
                        "function" == typeof e.then & amp; & amp;
                        (1 == ++i & amp; & amp;
            ...
            return (0, t.ZT)(n, e), n.prototype.register = function(e, n, r) {
                ...
                var e = this;
                void 0 === t & amp; & amp;
                (t = 500), this.flushing || (this.flushing = !0, setTimeout((function() {
                    e.flush().then((function() {
                        setTimeout((function() {
                            e.flushing = !1, e.queue.length & amp; & amp;
                            e.scheduleFlush(0)
                        }), 0)
                    }))
                }), t))
                ...
                return !(t instanceof J.Y & amp; & amp; !t.retry) & amp; & amp;
                ...
                var n, r, i = this.plugins.filter((function(t) {
                        var n, r, i;
                        if ("destination" !== t.type & amp; & amp;
                            "Segment.io" !== t.name) return !0;
                        var o = void 0;
                        return null === (n = t.alternativeNames) || void 0 === n || n.forEach((function(t) {
                            void 0 !== e[t] & amp; & amp;
                            (o = e[t])
                        })), null !== (i = null !== (r = e[t.name]) & amp; & amp; void 0 !== r ? r : o) & amp; & amp;
                        void 0 !== i ? i : !1 !== ("Segment.io" === t.name || e.All)
                    })),
                    o = (n = "type", r = {}, i.forEach((function(e) {
                        ...
                        } else n instanceof Function & amp; & amp;
                        (o = n(e));
                        void 0 !== o & amp; & amp;
                        (r[o] = (0, t.ev)((0, t.ev)([], null !== (i = r[o]) & amp; & amp; void 0 !== i ? i : [], !0), [e], !1))
                    })), r),
                    s = o.before,
                    u = void 0 === s ? [] : s,
                    a = o.enrichment,
                    ...
                    return (0, t.Jh)(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                ...
                                e.attempts & gt;
                                1 & amp; & amp;
                                this.emit("delivery_retry", e), i = this.availableExtensions(null !== (n = e.event.integrations) & amp; & amp; void 0 !== n ? n : {}), o = i.before, s = i.enrichment, u = 0, a = o, t.label = 1;
                            case 1:
                                return u & lt;
                                a.length ? (c = a[u], [4, (0, C.z)(e, c)]) : [3, 4];
                            case 2:
                                (d = t.sent()) instanceof J._ & amp; & amp;
                                (e = d), this.emit("message_enriched", e, c), t.label = 3;
                            case 3:
                                return u++, [3, 1];
                            case 4:
                                l = 0, p = s, t.label = 5;
                            case 5:
                                return l & lt;
                                p.length ? (f = p[l], [4, (0, C.a)(e, f)]) : [3, 8];
                            case 6:
                                (d = t.sent()) instanceof J._ & amp; & amp;
                                (e = d), this.emit("message_enriched", e, f), t.label = 7;
                            case 7:
                                return l++, [3, 5];
                            case 8:
                                return h = this.availableExtensions(null !== (r = e.event.integrations) & amp; & amp; void 0 !== r ? r : {}), v = h.destinations, y = h.after, [4, new Promise((function(t, n) {
                                    setTimeout((function() {
    ...
    function q(t) {
        for (var e = t.constructor.prototype, n = 0, r = Object.getOwnPropertyNames(e); n & lt; r.length; n++) {
            var i = r[n];
            if ("constructor" !== i) {
                var o = Object.getOwnPropertyDescriptor(t.constructor.prototype, i);
                o & amp; & amp;
                "function" == typeof o.value & amp; & amp;
                (t[i] = t[i].bind(t))
            }
        }
        return t
    ...
    var L = {
        ...
        R = function() {
            ...
            return t.prototype.get = function(t) {
                for (var e = null, n = 0, r = this.stores; n & lt; r.length; n++) {
                    var i = r[n];
                    try {
        ...
        K = function() {
            ...
            return t.prototype.get = function(t) {
                var e;
                return null !== (e = this.cache[t]) & amp; & amp;
                void 0 !== e ? e : null
            }, t.prototype.set = function(t, e) {
                this.cache[t] = e
    ...
    function U(t) {
        return t & amp; & amp;
        t.stores & amp; & amp;
        Array.isArray(t.stores) & amp; & amp;
    ...
    var Z = function t(e, n) {
            function r(t, r, i) {
                if ("undefined" != typeof document) {
                    "number" == typeof(i = B({}, n, i)).expires & amp; & amp;
                    (i.expires = new Date(Date.now() + 864e5 * i.expires)), i.expires & amp; & amp;
                    (i.expires = i.expires.toUTCString()), t = encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent).replace(/[()]/g, escape);
                    var o = "";
                    for (var s in i) i[s] & amp; & amp;
                    (o += "; " + s, !0 !== i[s] & amp; & amp;
                        (o += "=" + i[s].split(";")[0]));
            ...
            return Object.create({
                set: r,
                get: function(t) {
                    if ("undefined" != typeof document & amp; & amp;
                        (!arguments.length || t)) {
                        for (var n = document.cookie ? document.cookie.split("; ") : [], r = {}, i = 0; i & lt; n.length; i++) {
                            var o = n[i].split("="),
                                s = o.slice(1).join("=");
                            try {
            ...
            read: function(t) {
                return '"' === t[0] & amp; & amp;
                (t = t.slice(1, -1)), t.replace(/(%[\dA-F]{2})+/gi, decodeURIComponent)
            },
            write: function(t) {
        ...
        if (e)
            for (var n = function(t) {
                    var e = t.hostname.split("."),
                        n = e[e.length - 1],
                        r = [];
                    if (4 === e.length & amp; & amp; parseInt(n, 10) & gt; 0) return r;
                    if (e.length & lt; = 1) return r;
                    for (var i = e.length - 2; i & gt; = 0; --i) r.push(e.slice(i).join("."));
                    return r
                }(e), r = 0; r & lt; n.length; ++r) {
                var i = "__tld__",
                    o = n[r],
                    s = {
                        domain: "." + o
    ...
    var H = function() {
            function e(n) {
                void 0 === n & amp; & amp;
                (n = e.defaults), this.options = (0, t.pi)((0, t.pi)({}, e.defaults), n)
            }
            return Object.defineProperty(e, "defaults", {
                ...
                try {
                    ...
                    try {
                        return null !== (e = JSON.parse(n)) & amp; & amp;
                        void 0 !== e ? e : null
                    } catch (t) {
    ...
    var X = {
        ...
        tt = function() {
            function e(e, n) {
                ...
                this.options = {}, this.id = function(t) {
                    ...
                    void 0 !== t & amp; & amp;
                    (u.identityStore.set(u.idKey, t), t !== e & amp; & amp; null !== e & amp; & amp; null !== t & amp; & amp; u.anonymousId(null));
                    ...
                    if (u.options.disable) return null;
                    if (void 0 === t) {
                        var r = null !== (e = u.identityStore.getAndSync(u.anonKey)) & amp; & amp;
                        void 0 !== e ? e : null === (n = u.legacySIO()) || void 0 === n ? void 0 : n[0];
                        if (r) return r
                    }
                    ...
                    var e;
                    if (!u.options.disable) return null === t & amp; & amp;
                    (t = {}), t & amp; & amp;
                    u.traitsStore.set(u.traitsKey, null != t ? t : {}), null !== (e = u.traitsStore.get(u.traitsKey)) & amp; & amp;
                    void 0 !== e ? e : {}
                }, this.options = (0, t.pi)((0, t.pi)({}, X), e), this.cookieOptions = n, this.idKey = null !== (i = null === (r = e.cookie) || void 0 === r ? void 0 : r.key) & amp; & amp;
                void 0 !== i ? i : X.cookie.key, this.traitsKey = null !== (s = null === (o = e.localStorage) || void 0 === o ? void 0 : o.key) & amp; & amp;
                void 0 !== s ? s : X.localStorage.key, this.anonKey = "ajs_anonymous_id", this.identityStore = this.createStorage(this.options, n), this.legacyUserStore = this.createStorage(this.options, n, (function(t) {
                    return t === L.Cookie
                ...
                a & amp; & amp;
                "object" == typeof a & amp; & amp;
                (a.id & amp; & amp; this.id(a.id), a.traits & amp; & amp; this.traits(a.traits)), q(this)
            }
            return e.prototype.legacySIO = function() {
                ...
                if (!this.options.disable) {
                    ...
                    var r = this.id();
                    null !== r & amp; & amp;
                    r !== e || (n = (0, t.pi)((0, t.pi)({}, this.traits()), n)), e & amp; & amp;
                    this.id(e), this.traits(n)
                }
                ...
                return t.disable ? new R([]) : t.persist ? (void 0 !== t.storage & amp; & amp; null !== t.storage & amp; & amp; U(t.storage) & amp; & amp;
                    (r = t.storage.stores), t.localStorageFallbackDisabled & amp; & amp;
                    (r = r.filter((function(t) {
                        return t !== L.LocalStorage
                    }))), n & amp; & amp;
                    (r = r.filter(n)), new R(Q($(r, e)))) : new R([new K])
            }, e.defaults = X, e
        }(),
        et = {
            persist: !0,
            ...
            return (0, t.mG)(void 0, void 0, void 0, (function() {
                ...
                return (0, t.Jh)(this, (function(t) {
                    switch (t.label) {
                        ...
                        case 1:
                            return r & lt;
                            i.length ? (o = i[r], [4, ht(e, o).catch(console.error)]) : [3, 4];
                        case 2:
                            t.sent(), t.label = 3;
                        case 3:
                            return r++, [3, 1];
        ...
        ft = function(t, e, n, r) {
            void 0 === n & amp; & amp;
            (n = function() {}), void 0 === r & amp; & amp;
            (r = console.error), this.method = t, this.resolve = n, this.reject = r, this.called = !1, this.args = e
        },
        dt = function() {
            function e() {
                for (var t = [], e = 0; e & lt; arguments.length; e++) t[e] = arguments[e];
            ...
            return Object.defineProperty(e.prototype, "calls", {
                ...
                var e;
                return null !== (e = this.calls[t]) & amp; & amp;
                void 0 !== e ? e : []
            }, e.prototype.push = function() {
                for (var e = this, n = [], r = 0; r & lt; arguments.length; r++) n[r] = arguments[r];
                n.forEach((function(n) {
                    ["track", "screen", "alias", "group", "page", "identify"].includes(n.method) & amp; & amp;
                    !pt(n.args) & amp; & amp;
                    (n.args = (0, t.ev)((0, t.ev)([], n.args, !0), [_()], !1)), e.calls[n.method] ? e.calls[n.method].push(n) : e.calls[n.method] = [n]
                }))
    ...
    function ht(e, n) {
        return (0, t.mG)(this, void 0, Promise, (function() {
            ...
            return (0, t.Jh)(this, (function(t) {
                switch (t.label) {
                    case 0:
                        return t.trys.push([0, 3, , 4]), n.called ? [2, void 0] : (n.called = !0, r = e[n.method].apply(e, n.args), "object" == typeof(o = r) & amp; & amp; null !== o & amp; & amp;
                            "then" in o & amp; & amp;
                            "function" == typeof o.then ? [4, r] : [3, 2]);
                    case 1:
                        t.sent(), t.label = 2;
                    case 2:
    ...
    var vt = function() {
            ...
            return t.prototype.then = function() {
                for (var t, e = [], n = 0; n & lt; arguments.length; n++) e[n] = arguments[n];
                ...
                var e = this;
                return function() {
                    for (var n, r = [], i = 0; i & lt; arguments.length; i++) r[i] = arguments[i];
                    if (e.instance) {
    ...
    var bt = function(t) {
        var e;
        this.timeout = 300, this.writeKey = t.writeKey, this.cdnSettings = null !== (e = t.cdnSettings) & amp; & amp;
        void 0 !== e ? e : {
            integrations: {}
        }
    };
    ...
    var _t, xt = function(e) {
            function n(n, r, i, o, s) {
                ...
                var l = null == r ? void 0 : r.cookie,
                    p = null !== (u = null == r ? void 0 : r.disableClientPersistence) & amp; & amp;
                void 0 !== u & amp; & amp;
                u;
                ...
                return c._universalStorage = c.createStore(p, f, l), c._user = null != o ? o : new tt((0, t.pi)({
                    ...
                    persist: !p,
                    storage: null == r ? void 0 : r.storage
                }, null == r ? void 0 : r.group), l).load(), c.eventFactory = new A(c._user), c.integrations = null !== (a = null == r ? void 0 : r.integrations) & amp; & amp;
                void 0 !== a ? a : {}, c.options = null != r ? r : {}, q(c), c
            }
            return (0, t.ZT)(n, e), n.prototype.createStore = function(t, e, n) {
                return t ? new R([new K]) : e & amp; & amp;
                U(e) ? new R(Q($(e.stores, n))) : new R(Q([L.LocalStorage, {
                    name: L.Cookie,
                    settings: n
                }, L.Memory]))
                ...
                for (var e = [], n = 0; n & lt; arguments.length; n++) e[n] = arguments[n];
                return (0, t.mG)(this, void 0, Promise, (function() {
                ...
                return !1 === t & amp; & amp;
                localStorage.getItem("debug") & amp; & amp;
                localStorage.removeItem("debug"), this._debug = t, this
                ...
                return (0, t.mG)(this, void 0, Promise, (function() {
                    var r;
                    return (0, t.Jh)(this, (function(t) {
                        return r = new d._(e), (0, f.s)() & amp; & amp;
                        !this.options.retryQueue ? [2, r] : [2, v(r, this.queue, this, {
                            callback: n,
                            debug: this._debug,
                ...
                for (var e = [], n = 1; n & lt; arguments.length; n++) e[n - 1] = arguments[n];
                return this.queue.plugins.filter(F).forEach((function(n) {
                    "*" !== t & amp; & amp;
                    n.name.toLowerCase() !== t.toLowerCase() || n.addMiddleware.apply(n, e)
                ...
                get: function() {
                    var t;
                    return console.warn(yt), null !== (t = this._plugins) & amp; & amp;
                    void 0 !== t ? t : {}
                },
                enumerable: !1,
                configurable: !0
    ...
    var Mt = function() {
            ...
            this.name = "Page Enrichment", this.type = "before", this.version = "0.1.0", this.isLoaded = function() {
                ...
                return (0, t.mG)(e, void 0, void 0, (function() {
                    ...
                    return (0, t.Jh)(this, (function(t) {
                        switch (t.label) {
                            ...
                            case 1:
                                return t.trys.push([1, 3, , 4]), e = this, [4, Ot(this.instance.options.highEntropyValuesClientHints)];
                            case 2:
                ...
                void 0 === s.locale & amp; & amp;
                void 0 !== c & amp; & amp;
                (s.locale = c), null !== (i = s.library) & amp; & amp;
                void 0 !== i || (s.library = {
                    name: "analytics.js",
                ...
                (s.campaign = function(t) {
                    return t.startsWith("?") & amp; & amp;
                    (t = t.substring(1)), (t = t.replace(/\?/g, "&amp;")).split("&amp;").reduce((function(t, e) {
                        var n = e.split("="),
                            r = n[0],
                            i = n[1],
                            o = void 0 === i ? "" : i;
                        if (r.includes("utm_") & amp; & amp; r.length & gt; 4) {
                            var s = r.slice(4);
                            "campaign" === s & amp; & amp;
                            (s = "name"), t[s] = (0, It.a)(o)
                        }
                ...
                var l = function() {
                    var t = W.get("_ga");
                    if (t & amp; & amp; t.startsWith("amp")) return t
                }();
                l & amp; & amp;
                (s.amp = {
                    id: l
                ...
                function(e, n, r) {
                    var i, o = new R(r ? [] : [new H(kt())]),
                        ...
                        u = null !== (i = function(t) {
                            ...
                            t.startsWith("?") & amp; & amp;
                            (t = t.substring(1));
                            for (var n = 0, r = (t = t.replace(/\?/g, "&amp;")).split("&amp;"); n & lt; r.length; n++) {
                                var i = r[n].split("="),
                                    o = i[0],
                                    s = i[1];
                                if (e[o]) return {
                    ...
                    u & amp; & amp;
                    (n & amp; & amp;
                        (n.referrer = (0, t.pi)((0, t.pi)({}, n.referrer), u)), o.set("s:context.referrer", u))
                }(a, s, null !== (o = e.instance.options.disableClientPersistence) & amp; & amp; void 0 !== o & amp; & amp; o);
                try {
    ...
    function Ct(e, n, r, i, o, s) {
        ...
        return (0, t.mG)(this, void 0, Promise, (function() {
            ...
            return (0, t.Jh)(this, (function(h) {
                switch (h.label) {
                    case 0:
                        return l = [], p = null !== (a = null === (u = e.middlewareSettings) || void 0 === u ? void 0 : u.routingRules) & amp; & amp;
                        void 0 !== a ? a : [], f = (null !== (c = e.remotePlugins) & amp; & amp; void 0 !== c ? c : []).map((function(e) {
                                                ...
                                                function(t) {
                                                    ...
                                                    t.forEach((function(t) {
                                                        e.forEach((function(e) {
                                                            var n;
                                                            if (void 0 === t[e]) throw new Error("Plugin: ".concat(null !== (n = t.name) & amp; & amp; void 0 !== n ? n : "unknown", " missing required function ").concat(e))
                                                        }))
                                                    }))
    ...
    function qt(e, n) {
        var r, o, s, u, a, c = [],
            l = !1,
            p = null !== (r = null == n ? void 0 : n.size) & amp; & amp;
        void 0 !== r ? r : 10, f = null !== (o = null == n ? void 0 : n.timeout) & amp; & amp;
        void 0 !== o ? o : 5e3;
        ...
        return u = function(t) {
            if ((l = t) & amp; & amp; c.length) {
                var e = function(t) {
                    var e = [],
                        n = 0;
                    return t.forEach((function(t) {
                        Gt(e[n]) & gt; = 64 & amp; & amp;
            ...
            dispatch: function(e, n) {
                return (0, t.mG)(this, void 0, Promise, (function() {
                    var e;
                    return (0, t.Jh)(this, (function(t) {
                        return c.push(n), e = c.length & gt; = p || function(t) {
                            return Gt(t) & gt; = 450
    ...
    function Lt(e, n, r, i) {
        ...
        for (var l in i) {
            var p = i[l];
            "Segment.io" === l & amp; & amp;
            a.push(l), "bundled" === p.bundlingStatus & amp; & amp;
            a.push(l), "unbundled" === p.bundlingStatus & amp; & amp;
            c.push(l)
        }
        for (var f = 0, d = (null == r ? void 0 : r.unbundledIntegrations) || []; f & lt; d.length; f++) {
            var h = d[f];
            c.includes(h) || c.push(h)
        }
        var v = null !== (o = null == r ? void 0 : r.maybeBundledConfigIds) & amp; & amp;
        void 0 !== o ? o : {}, y = [];
        return a.sort().forEach((function(t) {
            var e;
            (null !== (e = v[t]) & amp; & amp; void 0 !== e ? e : []).forEach((function(t) {
                y.push(t)
            }))
        })), !1 !== (null == r ? void 0 : r.addBundledMetadata) & amp; & amp;
    ...
    function Wt(e, n, r) {
        ...
        var a, c = null !== (o = null == n ? void 0 : n.apiKey) & amp; & amp;
        void 0 !== o ? o : "", l = e.options.disableClientPersistence ? new T.Z(e.queue.queue.maxAttempts, []) : new D.$(e.queue.queue.maxAttempts, "".concat(c, ":dest-Segment.io")), p = new Set, d = !1, h = null !== (s = null == n ? void 0 : n.apiHost) & amp; & amp;
        void 0 !== s ? s : Zt.U, v = null !== (u = null == n ? void 0 : n.protocol) & amp; & amp;
        void 0 !== u ? u : "https", y = "".concat(v, "://").concat(h), m = null == n ? void 0 : n.deliveryStrategy, g = "batching" === (null == m ? void 0 : m.strategy) ? qt(h, m.config) : (a = null == m ? void 0 : m.config, {
        ...
        function b(i) {
            return (0, t.mG)(this, void 0, Promise, (function() {
                var o, s;
                return (0, t.Jh)(this, (function(t) {
                    return (0, f.s)() ? (l.push(i), Kt(d, l, w, Kt), [2, i]) : (p.add(i), o = i.event.type.charAt(0), s = (0, Nt.D)(i.event).json(), "track" === i.event.type & amp; & amp; delete s.traits, "alias" === i.event.type & amp; & amp;
                        (s = function(t, e) {
                            var n, r, i, o, s = t.user();
                            return e.previousId = null !== (i = null !== (r = null !== (n = e.previousId) & amp; & amp; void 0 !== n ? n : e.from) & amp; & amp; void 0 !== r ? r : s.id()) & amp; & amp;
                            void 0 !== i ? i : s.anonymousId(), e.userId = null !== (o = e.userId) & amp; & amp;
                            void 0 !== o ? o : e.to, delete e.from, delete e.to, e
        ...
        return l.todo & amp; & amp;
        Kt(d, l, w, Kt), w
    }
    var Vt = null !== (Ut = (Bt = (0, it.R)()).__SEGMENT_INSPECTOR__) & amp; & amp;
    void 0 !== Ut ? Ut : Bt.__SEGMENT_INSPECTOR__ = {}, Ht = s(6218);
    ...
    function Qt(e, n, i, o, u, a) {
        ...
        (u = []), (0, t.mG)(this, void 0, Promise, (function() {
                ...
                switch (O.label) {
                    case 0:
                        return f = null == u ? void 0 : u.filter((function(t) {
                                ...
                                return "function" == typeof t & amp; & amp;
                                "string" == typeof t.pluginName
                            })),
                            function(t) {
                                var e, n, i;
                                return "test" !== r().NODE_ENV & amp; & amp;
                                (null !== (i = null === (n = null === (e = t.middlewareSettings) || void 0 === e ? void 0 : e.routingRules) || void 0 === n ? void 0 : n.length) & amp; & amp; void 0 !== i ? i : 0) & gt;
                                0
                    ...
                    case 2:
                        v = void 0, O.label = 3;
                    case 3:
                        return h = v, k = n, "test" !== r().NODE_ENV & amp; & amp;
                        Object.keys(k.integrations).length & gt;
                        1 || a.length & gt;
                        0 ? [4, s.e(464).then(s.bind(s, 3162)).then((function(t) {
                    ...
                    case 12:
                        return _ = O.sent(), x = (0, t.ev)((0, t.ev)((0, t.ev)([Et], f, !0), y, !0), _, !0), g & amp; & amp;
                        x.push(g), !1 === (null === (l = o.integrations) || void 0 === l ? void 0 : l.All) & amp; & amp;
                        !o.integrations["Segment.io"] || o.integrations & amp; & amp;
                        !1 === o.integrations["Segment.io"] ? [3, 14] : (P = (S = x).push, [4, Wt(i, w["Segment.io"], n.integrations)]);
                    case 13:
                        P.apply(S, [O.sent()]), O.label = 14;
                    case 14:
                        return [4, i.register.apply(i, x)];
                    case 15:
                        return j = O.sent(), Object.entries(null !== (p = n.enabledMiddleware) & amp; & amp; void 0 !== p ? p : {}).some((function(t) {
                            return t[1]
    ...
    function $t(n, r, o) {
        ...
        (r = {}), (0, t.mG)(this, void 0, Promise, (function() {
            var m, g, b, w, _, x, S, P, j, I, O;
            return (0, t.Jh)(this, (function(k) {
                switch (k.label) {
                    case 0:
                        return !0 === r.disable ? [2, [new St, d._.system()]] : (r.globalAnalyticsKey & amp; & amp;
                            (0, ot.jV)(r.globalAnalyticsKey), n.cdnURL & amp; & amp;
                            (0, e.UH)(n.cdnURL), r.initialPageview & amp; & amp; o.push(new ft("page", [])), null === (s = n.cdnSettings) || void 0 === s ? [3, 1] : (g = s, [3, 3]));
                    case 1:
                    ...
                    case 2:
                        g = k.sent(), k.label = 3;
                    case 3:
                        return m = g, r.updateCDNSettings & amp; & amp;
                        (m = r.updateCDNSettings(m)), "function" != typeof r.disable ? [3, 5] : [4, r.disable(m)];
                    case 4:
                        if (k.sent()) return [2, [new St, d._.system()]];
                        k.label = 5;
                    case 5:
                        return b = null === (a = null === (u = m.integrations["Segment.io"]) || void 0 === u ? void 0 : u.retryQueue) || void 0 === a || a, r = (0, t.pi)({
                            ...
                            function(t) {
                                ...
                                cdnSettings: m
                            }), r)), _ = null !== (c = n.plugins) & amp; & amp;
                        void 0 !== c ? c : [], x = null !== (l = n.classicIntegrations) & amp; & amp;
                        void 0 !== l ? l : [], S = null === (p = r.integrations) || void 0 === p ? void 0 : p["Segment.io"], Ht.j.initRemoteMetrics((0, t.pi)((0, t.pi)({}, m.metrics), {
                                host: null !== (f = null == S ? void 0 : S.apiHost) & amp; & amp;void 0 !== f ? f : null === (h = m.metrics) || void 0 === h ? void 0 : h.host,
                    ...
                    case 6:
                        return P = k.sent(), j = null !== (v = window.location.search) & amp; & amp;
                        void 0 !== v ? v : "", I = null !== (y = window.location.hash) & amp; & amp;
                        void 0 !== y ? y : "", (O = j.length ? j : I.replace(/(?=#).*(?=\?)/, "")).includes("ajs_") ? [4, w.queryString(O).catch(console.error)] : [3, 8];
                    case 7:
                        k.sent(), k.label = 8;
                    case 8:
    ...
    var Xt = function(e) {
            ...
            return (0, t.ZT)(n, e), n.prototype.load = function(t, e) {
                return void 0 === e & amp; & amp;
                (e = {}), this._resolveLoadStart(t, e), this
            }, n.load = function(t, e) {
                return void 0 === e & amp; & amp;
                (e = {}), (new n).load(t, e)
                ...
                switch (t.label) {
                    case 0:
                        return r = function() {
                            ...
                            for (var n = /http.*\/analytics\.js\/v1\/([^/]*)(\/platform)?\/analytics.*/, r = void 0, i = 0, o = Array.prototype.slice.call(document.querySelectorAll("script")); i & lt; o.length; i++) {
                                var s = null !== (t = o[i].getAttribute("src")) & amp; & amp;
                                void 0 !== t ? t : "";
                                if ((u = n.exec(s)) & amp; & amp; u[1]) {
                                    r = u[1];
                                    break
                                }
                            }
                            if (!r & amp; & amp; document.currentScript) {
                                var u;
                                s = document.currentScript.src, (u = n.exec(s)) & amp; & amp;
                                u[1] & amp; & amp;
                                (r = u[1])
                            }
                            return r
                        }(), i = null !== (n = null === (e = (0, ot.wI)()) || void 0 === e ? void 0 : e._loadOptions) & amp; & amp;
                        void 0 !== n ? n : {}, r ? (o = ot.ql, [4, Xt.standalone(r, i)]) : (console.error("Failed to load Write Key. Make sure to use the latest version of the Segment snippet, which can be found in your source settings."), [2]);
                    case 1:
    ...
    document.addEventListener("securitypolicyviolation", (function(n) {
        ...
        function(t) {
            return "report" !== t.disposition & amp; & amp;
            t.blockedURI.includes("cdn.segment")
        }(n) & amp; & amp;
        (oe = !0, se(["type:csp"]), function() {
            return (0, t.mG)(this, void 0, Promise, (function() {
                var n;
                return (0, t.Jh)(this, (function(t) {
                    switch (t.label) {
    ...
    if (ae & amp; & amp;
        ...
        function() {
            var t = {
                ...
                e = !!window.MSInputMethodContext & amp; & amp;
            !!document.documentMode, n = navigator.userAgent.split(" "), r = n[n.length - 1].split("/"), i = r[0], o = r[1];
            return e || void 0 !== t[i] & amp; & amp;
            t[i] & gt; = parseInt(o)
        }()) {
...
//# sourceMappingURL=standalone.js.map</pre></body></html>